...
import com.iterium.tmdb.MovieDatasetHandler.{extractSingleValuedColumns, readContents, retrieveTopMoviesByBudget}
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val topMoviesByBudget = timed("Extracting top movies by budget", retrieveTopMoviesByBudget(singleValDF))
